...
public abstract class BookCollection implements BookCollectionInterface {
	...
	public String[] booktitles() {
        ...
        //Abans estava private, protected per poder accedir des de la subclasse
        //Shopping Cart
	...
	public void removeCopies( int numberOfCopies, String booktitle ) {
        ...
        //Returns a lisr of an String array with the information of 
        //books in the books.xml file
