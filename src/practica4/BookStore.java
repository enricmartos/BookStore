...
public class BookStore extends javax.swing.JFrame {
	...
	catalog = catinit;
	cart = cartinit;
        //Parsejem el Linked List d'Arrays d'Strings en els Stocks
        //que formen el Catalog
...
private String[] copyChoices() {
	...
	int copies = catalog.numberOfCopies( booktitle );
        //Util per desplegar la llista amb totes les còpies disponibles
        //d'un cert llibre
...
//Acció al prémer el Button Move To Shopping Cart
